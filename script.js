  ...
  customPlayer.innerHTML = `
    ...
    <div class="controls">
      ...
      <svg viewBox="0 0 24 24" class="icon fullscreen">
        <path d="M7 14H5v5h5v-2H7v-3zm0-4h2V7h3V5H7v5zm10 9h-3v2h5v-5h-2v3zm0-14V5h-5v2h3v3h2V5z"/>
      </svg>
    </button>
    </div>
  `;
...
// ===============================  
// Pausar vídeo clicando no vídeo
// ===============================
const customPlayer = document.querySelector(".custom-player");
...
// Mobile / Safari
customPlayer.addEventListener("touchstart", togglePlay);
